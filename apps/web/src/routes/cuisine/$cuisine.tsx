        ...
        <section className="mb-6">
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="border-warm-700/50 bg-surface-raised text-ink-muted hover:border-flame-500/40 hover:text-flame-400 inline-flex min-h-11 items-center gap-1.5 rounded-lg border px-3 text-sm"
            >

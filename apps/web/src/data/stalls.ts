...
export { countryLabels, timeCategoryLabels, timeCategoryIcons, slugify, parseTimeCategories };
...
export function getStallArea(stall: Stall): string {
  ...
  // West
  if (
    a.includes("bukit batok") ||
    a.includes("jurong") ||
    a.includes("clementi") ||
    a.includes("west coast")
  )
    return "West";
  // North
  if (
    a.includes("yishun") ||
    a.includes("sembawang") ||
    a.includes("woodlands") ||
    a.includes("marsiling") ||
    a.includes("ang mo kio") ||
    a.includes("upper thomson")
  )
    return "North";
  // North-East
  if (
    a.includes("serangoon") ||
    a.includes("kovan") ||
    a.includes("chomp chomp") ||
    a.includes("hougang") ||
    a.includes("sengkang") ||
    a.includes("punggol")
  )
  ...
  if (
    a.includes("geylang") ||
    a.includes("e coast") ||
    a.includes("east coast") ||
    a.includes("siglap") ||
    a.includes("bedok") ||
    a.includes("changi") ||
    a.includes("loyang") ||
    a.includes("eunos") ||
    a.includes("joo chiat") ||
    a.includes("katong") ||
    a.includes("onan rd") ||
    a.includes("tanjong katong")
  )
    return "East";
  ...
  if (
    a.includes("seng poh") ||
    a.includes("tiong bahru") ||
    a.includes("bukit merah") ||
    a.includes("kim tian") ||
    a.includes("telok blangah") ||
    a.includes("havelock") ||
    a.includes("zion rd") ||
    a.includes("alexandra")
  )
    return "Tiong Bahru / Bukit Merah";
  // Central - Beach Road / Bugis / Golden Mile
  if (
    a.includes("beach rd") ||
    a.includes("golden mile") ||
    a.includes("horne rd") ||
    a.includes("hamilton rd") ||
    a.includes("jalan berseh") ||
    a.includes("crawford") ||
    a.includes("lavender")
  )
    return "Bugis / Beach Road";
  // Central - CBD / Chinatown
  if (
    a.includes("upper cross") ||
    a.includes("new bridge") ||
    a.includes("smith st") ||
    a.includes("maxwell") ||
    a.includes("amoy") ||
    a.includes("shenton") ||
    a.includes("anson") ||
    a.includes("raffles place") ||
    a.includes("kadayanallur") ||
    a.includes("cross st")
  )
    return "CBD / Chinatown";
  // Central - Orchard / Newton
  if (
    a.includes("orchard") ||
    a.includes("killiney") ||
    a.includes("holland") ||
    a.includes("bukit timah") ||
    a.includes("vista exchange") ||
    a.includes("sinaran")
  )
    return "Orchard / Holland";
  // Central - others
  if (
    a.includes("rangoon") ||
    a.includes("foch rd") ||
    a.includes("macpherson") ||
    a.includes("tai thong") ||
    a.includes("veerasamy")
  )
    return "Central";
...
const hokkienMeeStalls: Stall[] = [
  {
    ...
    youtubeTitle:
      "Geylang Lorong 29 Fried Hokkien Mee Review | The Best Hokkien Mee in Singapore Ep 1",
    youtubeVideoId: "VtI1jReYURc",
  ...
  },
  {
    ...
    youtubeTitle:
      "Yong Heng X 777 Fried Hokkien Prawn Mee Review | The Best Hokkien Mee in Singapore Ep 3",
    youtubeVideoId: "C3ZHkCbk9lE",
  ...
  },
  {
    ...
    misses: [
      "Chilli tastes very raw, cleans out other flavors",
      "Strong alkaline taste of noodles",
    ],
    youtubeTitle: "",
  ...
  },
  {
    ...
    ratingModerated: 2,
    hits: [
      "Ample seafood flavor",
      "Some creamy, fatty flavor",
  ...
  },
  {
    ...
    hits: ["Very tasty"],
    misses: [
      "Mock abalone gives an off stock flavor",
      "Insanely spicy chilli with little to no taste",
    ],
    youtubeTitle: "",
  ...
  },
  {
    ...
    youtubeTitle:
      "Golden Mile Hainan x YouFu Hokkien Mee Review | The Best Hokkien Mee in Singapore Ep 8",
    youtubeVideoId: "KPcVViNXiao",
  ...
  },
  {
    ...
    youtubeTitle:
      "Hong Heng Fried Sotong Prawn Mee 鸿興炒蘇東蝦麵 Review | The Best Hokkien Mee in Singapore Ep 11",
    youtubeVideoId: "FYwR2CruOhg",
  ...
  },
  {
    ...
    ratingModerated: 3,
    hits: [
      "Well-represented 3 pillars of hokkien mee",
      "Great texture of noodles",
      "Perfect broth consistency",
      "Well-balanced, rich but not cloy",
    ],
    misses: ["Probably have to come daily"],
    youtubeTitle:
      "Come Daily Fried Hokkien Prawn Mee Review | The Best Hokkien Mee in Singapore Ep 12",
    youtubeVideoId: "lu43mArWhhQ",

...
export function splitOpeningTimesForDisplay(value: string | null | undefined): string[] {
...
export function getStallArea(stall: Stall): string {
  ...
  if (
    address.includes("bukit batok") ||
    address.includes("jurong") ||
    address.includes("clementi") ||
    address.includes("west coast")
  )
    return "West";
  if (
    address.includes("yishun") ||
    address.includes("sembawang") ||
    address.includes("woodlands") ||
    address.includes("marsiling") ||
    address.includes("ang mo kio") ||
    address.includes("upper thomson")
  )
    return "North";
  if (
    address.includes("serangoon") ||
    address.includes("kovan") ||
    address.includes("chomp chomp") ||
    address.includes("hougang") ||
    address.includes("sengkang") ||
    address.includes("punggol")
  )
    return "North-East";
  if (
    address.includes("geylang") ||
    address.includes("e coast") ||
    address.includes("east coast") ||
    address.includes("siglap") ||
    address.includes("bedok") ||
    address.includes("changi") ||
    address.includes("loyang") ||
    address.includes("eunos") ||
    address.includes("joo chiat") ||
    address.includes("katong") ||
    address.includes("onan rd") ||
    address.includes("tanjong katong")
  )
    return "East";
  ...
  if (
    address.includes("seng poh") ||
    address.includes("tiong bahru") ||
    address.includes("bukit merah") ||
    address.includes("kim tian") ||
    address.includes("telok blangah") ||
    address.includes("havelock") ||
    address.includes("zion rd") ||
    address.includes("alexandra")
  )
    return "Tiong Bahru / Bukit Merah";
  if (
    address.includes("beach rd") ||
    address.includes("golden mile") ||
    address.includes("horne rd") ||
    address.includes("hamilton rd") ||
    address.includes("jalan berseh") ||
    address.includes("crawford") ||
    address.includes("lavender")
  )
    return "Bugis / Beach Road";
  if (
    address.includes("upper cross") ||
    address.includes("new bridge") ||
    address.includes("smith st") ||
    address.includes("maxwell") ||
    address.includes("amoy") ||
    address.includes("shenton") ||
    address.includes("anson") ||
    address.includes("raffles place") ||
    address.includes("kadayanallur") ||
    address.includes("cross st")
  )
    return "CBD / Chinatown";
  if (
    address.includes("orchard") ||
    address.includes("killiney") ||
    address.includes("holland") ||
    address.includes("bukit timah") ||
    address.includes("vista exchange") ||
    address.includes("sinaran")
  )
    return "Orchard / Holland";
  if (
    address.includes("rangoon") ||
    address.includes("foch rd") ||
    address.includes("macpherson") ||
    address.includes("tai thong") ||
    address.includes("veerasamy") ||
    address.includes("ghim moh") ||
    address.includes("shunfu")
  )
    return "Central";
